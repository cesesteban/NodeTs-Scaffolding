...
var IRequestCreateUser = /** @class */ (function () {
    function IRequestCreateUser() {
        this.username = '';
        this.firstName = '';
        this.lastName = '';
        this.email = '';
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], IRequestCreateUser.prototype, "email", void 0);
    __decorate([
        (0, class_validator_1.IsString)({ message: 'Password must be a string' }),
        (0, class_validator_1.Length)(1, 255, { message: 'Password must be between 1 and 255 characters' }),
        __metadata("design:type", String)
    ], IRequestCreateUser.prototype, "password", void 0);
    __decorate([
    ...
    ], IRequestCreateUser.prototype, "roleId", void 0);
    __decorate([
        (0, class_validator_1.IsNumber)({ allowNaN: false, allowInfinity: false, maxDecimalPlaces: 12 }, { message: 'country_id must be a number' }),
        __metadata("design:type", Number)
    ], IRequestCreateUser.prototype, "countryId", void 0);
    return IRequestCreateUser;
}());
exports.default = IRequestCreateUser;
